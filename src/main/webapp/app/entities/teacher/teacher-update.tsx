    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="myapplicationApp.teacher.home.createOrEditLabel">
              <Translate contentKey="myapplicationApp.teacher.home.createOrEditLabel">Create or edit a Teacher</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : teacherEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="teacher-age" type="number" className="form-control" name="age" />
                </AvGroup>
                <AvGroup>
