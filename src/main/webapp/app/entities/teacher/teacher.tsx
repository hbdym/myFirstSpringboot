    ...
    return (
      <div>
        <h2 id="teacher-heading">
          <Translate contentKey="myapplicationApp.teacher.home.title">Teachers</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="myapplicationApp.teacher.home.createLabel">Create new Teacher</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('name')}>
                  <Translate contentKey="myapplicationApp.teacher.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('age')}>
                  <Translate contentKey="myapplicationApp.teacher.age">Age</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('sex')}>
                  <Translate contentKey="myapplicationApp.teacher.sex">Sex</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
